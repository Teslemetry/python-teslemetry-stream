...
class Signal(StrEnum):
    ...
    BRICK_SOC_MIN_PERCENT = "BrickSocMinPercent"
    ...
    GPS_STATE = "GpsState"
    GRADE_ESTIMATE_PERCENT = "GradeEstimatePercent"
    ...
    LIFETIME_ENERGY_CHARGED_KWH = "LifetimeEnergyChargedKwh"
    ...
    MAX_SPEED_TO_REACH_DESTINATION_MPH = "MaxSpeedToReachDestinationMph"
    ...
    NOMINAL_FULL_PACK_ENERGY_KWH = "NominalFullPackEnergyKwh"
    ...
    SEMI_CRUISE_SPEED_LIMIT_MPH = "SemiCruiseSpeedLimitMph"
    ...
    SOC = "Soc"
    SOFTWARE_UPDATE_AVAILABLE = "SoftwareUpdateAvailable"
    ...
    SOFTWARE_UPDATE_IN_PROGRESS = "SoftwareUpdateInProgress"
