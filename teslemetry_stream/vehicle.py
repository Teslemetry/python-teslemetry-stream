...
class TeslemetryStreamVehicle:
    ...
    async def add_field(self, field: Signal | str, interval: int | None = None) -> None:
        ...
        if field in self.fields and (
            ...
            LOGGER.debug(
                ...
                field,
                self.fields[field].get("interval_seconds"),
            )
            return
    ...
    def listen_Alerts(
        ...
        """Listen for Alerts."""
        return self.stream.async_add_listener(
            lambda x: callback(x[Key.ALERTS]), {Key.VIN: self.vin, Key.ALERTS: None}
        )
    ...
    def listen_Errors(
        ...
        """Listen for Errors."""
        return self.stream.async_add_listener(
            lambda x: callback(x[Key.ERRORS]), {Key.VIN: self.vin, Key.ERRORS: None}
        )

    # Add listeners for each signal
    def listen_ACChargingEnergyIn(
    ...
    def listen_AutoSeatClimateLeft(
    ...
    def listen_AutoSeatClimateRight(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_AutomaticBlindSpotCamera(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_AutomaticEmergencyBrakingOff(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_BlindSpotCollisionWarningChime(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            ...
            {
                "vin": self.vin,
                "data": {Signal.BLIND_SPOT_COLLISION_WARNING_CHIME: None},
            },
        )

    def listen_BmsFullchargecomplete(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_CabinOverheatProtectionMode(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                CabinOverheatProtectionModeState.get(
                    x["data"][Signal.CABIN_OVERHEAT_PROTECTION_MODE]
                )
            ),
            {"vin": self.vin, "data": {Signal.CABIN_OVERHEAT_PROTECTION_MODE: None}},
        )

    def listen_CabinOverheatProtectionTemperatureLimit(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                ClimateOverheatProtectionTempLimit.get(
                    x["data"][Signal.CABIN_OVERHEAT_PROTECTION_TEMPERATURE_LIMIT]
                )
            ),
            {
                "vin": self.vin,
                "data": {Signal.CABIN_OVERHEAT_PROTECTION_TEMPERATURE_LIMIT: None},
            },
        )
    ...
    def listen_ChargeCurrentRequest(
    ...
    def listen_ChargeCurrentRequestMax(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_ChargeEnableRequest(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_ChargePortColdWeatherMode(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_ChargePortLatch(
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                ChargePortLatch.get(x["data"][Signal.CHARGE_PORT_LATCH])
            ),
            {"vin": self.vin, "data": {Signal.CHARGE_PORT_LATCH: None}},
        )

    def listen_ChargerVoltage(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_ClimateKeeperMode(
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                ClimateKeeperModeState.get(x["data"][Signal.CLIMATE_KEEPER_MODE])
            ),
    ...
    def listen_CruiseFollowDistance(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                FollowDistance.get(x["data"][Signal.CRUISE_FOLLOW_DISTANCE])
            ),
            {"vin": self.vin, "data": {Signal.CRUISE_FOLLOW_DISTANCE: None}},
        )

    def listen_CruiseSetSpeed(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_DefrostForPreconditioning(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_DestinationLocation(
    ...
    def listen_DetailedChargeState(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                DetailedChargeState.get(x["data"][Signal.DETAILED_CHARGE_STATE])
            ),
            {"vin": self.vin, "data": {Signal.DETAILED_CHARGE_STATE: None}},
        )

    def listen_DiAxleSpeedF(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_EmergencyLaneDepartureAvoidance(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            ...
            {
                "vin": self.vin,
                "data": {Signal.EMERGENCY_LANE_DEPARTURE_AVOIDANCE: None},
            },
        )

    def listen_EnergyRemaining(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_EstimatedHoursToChargeTermination(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            ...
            {
                "vin": self.vin,
                "data": {Signal.ESTIMATED_HOURS_TO_CHARGE_TERMINATION: None},
            },
        )

    def listen_EuropeVehicle(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_ExpectedEnergyPercentAtTripArrival(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            ...
            {
                "vin": self.vin,
                "data": {Signal.EXPECTED_ENERGY_PERCENT_AT_TRIP_ARRIVAL: None},
            },
        )

    def listen_ExteriorColor(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_ForwardCollisionWarning(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                ForwardCollisionSensitivity.get(
                    x["data"][Signal.FORWARD_COLLISION_WARNING]
                )
            ),
            {"vin": self.vin, "data": {Signal.FORWARD_COLLISION_WARNING: None}},
        )

    def listen_FrontPassengerWindow(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_GuestModeMobileAccessState(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                GuestModeMobileAccess.get(
                    x["data"][Signal.GUEST_MODE_MOBILE_ACCESS_STATE]
                )
            ),
            {"vin": self.vin, "data": {Signal.GUEST_MODE_MOBILE_ACCESS_STATE: None}},
        )

    def listen_HomelinkDeviceCount(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_HvacLeftTemperatureRequest(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_HvacRightTemperatureRequest(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_HvacSteeringWheelHeatAuto(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_HvacSteeringWheelHeatLevel(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_IsolationResistance(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_LaneDepartureAvoidance(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                LaneAssistLevel.get(x["data"][Signal.LANE_DEPARTURE_AVOIDANCE])
            ),
            {"vin": self.vin, "data": {Signal.LANE_DEPARTURE_AVOIDANCE: None}},
        )

    def listen_LateralAcceleration(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_LongitudinalAcceleration(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_NotEnoughPowerToHeat(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_OffroadLightbarPresent(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_PairedPhoneKeyAndKeyFobQty(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_PowershareHoursLeft(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_PowershareInstantaneousPowerKW(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_PowershareStatus(
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                PowershareState.get(x["data"][Signal.POWERSHARE_STATUS])
            ),
            {"vin": self.vin, "data": {Signal.POWERSHARE_STATUS: None}},
        )

    def listen_PowershareStopReason(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                PowershareStopReasonStatus.get(x["data"][Signal.POWERSHARE_STOP_REASON])
            ),
            {"vin": self.vin, "data": {Signal.POWERSHARE_STOP_REASON: None}},
        )

    def listen_PowershareType(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                PowershareTypeStatus.get(x["data"][Signal.POWERSHARE_TYPE])
            ),
            {"vin": self.vin, "data": {Signal.POWERSHARE_TYPE: None}},
        )

    def listen_PreconditioningEnabled(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_RearDisplayHvacEnabled(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_RouteTrafficMinutesDelay(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_RearPassengerWindow(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_ScheduledChargingMode(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                ScheduledChargingMode.get(x["data"][Signal.SCHEDULED_CHARGING_MODE])
            ),
            {"vin": self.vin, "data": {Signal.SCHEDULED_CHARGING_MODE: None}},
        )

    def listen_ScheduledChargingPending(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_ScheduledChargingStartTime(
        self, callback: Callable[[datetime | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_ScheduledDepartureTime(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_SeatHeaterRearCenter(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_SeatHeaterRearRight(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_SettingChargeUnit(
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                ChargeUnitPreference.get(x["data"][Signal.SETTING_CHARGE_UNIT])
            ),
            {"vin": self.vin, "data": {Signal.SETTING_CHARGE_UNIT: None}},
        )

    def listen_SettingDistanceUnit(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                DistanceUnit.get(x["data"][Signal.SETTING_DISTANCE_UNIT])
            ),
            {"vin": self.vin, "data": {Signal.SETTING_DISTANCE_UNIT: None}},
        )

    def listen_SettingTemperatureUnit(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                TemperatureUnit.get(x["data"][Signal.SETTING_TEMPERATURE_UNIT])
            ),
            {"vin": self.vin, "data": {Signal.SETTING_TEMPERATURE_UNIT: None}},
        )

    def listen_SettingTirePressureUnit(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                PressureUnit.get(x["data"][Signal.SETTING_TIRE_PRESSURE_UNIT])
            ),
    ...
    def listen_SoftwareUpdateDownloadPercentComplete(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            ...
            {
                "vin": self.vin,
                "data": {Signal.SOFTWARE_UPDATE_DOWNLOAD_PERCENT_COMPLETE: None},
            },
        )

    def listen_SoftwareUpdateExpectedDurationMinutes(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            ...
            {
                "vin": self.vin,
                "data": {Signal.SOFTWARE_UPDATE_EXPECTED_DURATION_MINUTES: None},
            },
        )

    def listen_SoftwareUpdateInstallationPercentComplete(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            ...
            {
                "vin": self.vin,
                "data": {Signal.SOFTWARE_UPDATE_INSTALLATION_PERCENT_COMPLETE: None},
            },
        )
    ...
    def listen_SoftwareUpdateVersion(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_SpeedLimitWarning(
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                SpeedAssistLevel.get(x["data"][Signal.SPEED_LIMIT_WARNING])
            ),
            {"vin": self.vin, "data": {Signal.SPEED_LIMIT_WARNING: None}},
        )

    def listen_SuperchargerSessionTripPlanner(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_TonneauPosition(
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                TonneauPositionState.get(x["data"][Signal.TONNEAU_POSITION])
            ),
            {"vin": self.vin, "data": {Signal.TONNEAU_POSITION: None}},
        )

    def listen_TonneauTentMode(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                TonneauTentModeState.get(x["data"][Signal.TONNEAU_TENT_MODE])
            ),
    ...
    def listen_TpmsLastSeenPressureTimeFl(
        self, callback: Callable[[datetime | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_TpmsLastSeenPressureTimeFr(
        self, callback: Callable[[datetime | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_TpmsLastSeenPressureTimeRl(
        self, callback: Callable[[datetime | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_TpmsLastSeenPressureTimeRr(
        self, callback: Callable[[datetime | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_LightsHazardsActive(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_LightsTurnSignal(
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                TurnSignalState.get(x["data"][Signal.LIGHTS_TURN_SIGNAL])
            ),
            {"vin": self.vin, "data": {Signal.LIGHTS_TURN_SIGNAL: None}},
        )

    def listen_LightsHighBeams(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_MediaPlaybackStatus(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                MediaStatus.get(x["data"][Signal.MEDIA_PLAYBACK_STATUS])
            ),
            {"vin": self.vin, "data": {Signal.MEDIA_PLAYBACK_STATUS: None}},
        )

    def listen_MediaPlaybackSource(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_MediaNowPlayingDuration(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_MediaNowPlayingElapsed(
        self, callback: Callable[[int | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_MediaNowPlayingArtist(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_MediaNowPlayingTitle(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_MediaNowPlayingAlbum(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_MediaNowPlayingStation(
        self, callback: Callable[[str | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_MediaAudioVolumeIncrement(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_MediaAudioVolumeMax(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_SunroofInstalled(
        ...
        return self.stream.async_add_listener(
            lambda x: callback(
                SunroofInstalledState.get(x["data"][Signal.SUNROOF_INSTALLED])
            ),
            {"vin": self.vin, "data": {Signal.SUNROOF_INSTALLED: None}},
        )

    def listen_SeatVentEnabled(
        self, callback: Callable[[bool | None], None]
    ) -> Callable[[], None]:
    ...
    def listen_ChargeRateMilePerHour(
        self, callback: Callable[[float | None], None]
    ) -> Callable[[], None]:
...
def make_location(
    ...
    def typer(event: dict):
        ...
        if isinstance(data, dict) and "longitude" in data and "latitude" in data:
            callback(
                TeslaLocation(latitude=data["latitude"], longitude=data["longitude"])
            )
        else:
            callback(None)
